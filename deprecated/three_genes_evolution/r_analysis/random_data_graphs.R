...
original_data <- read.table("random_data5.tsv", header=TRUE)
...
ggsave("/home/sahil/pinetree-toys/three_genes_evolution/final_program/random_data5_graph.jpg", gen_plots, width=20, height=10)
