...
genome <- read.table("genome_tracker_8255.tsv", header=TRUE)
...
ggsave("/home/wilkelab/pinetree-toys/three_genes_evolution/modularized_files/genome_architecture.pdf", genome_plot, width=30, height=30, limitsize=FALSE)
```
