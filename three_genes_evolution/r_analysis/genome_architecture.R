...
#Draw promoters
if((genome[4, 1] >= 122) & (genome[4, 2] <= 132)){
...
if((genome[4, 1] >= 133) & (genome[4, 2] <= 143)){
...
if((genome[5, 1] >= 281) & genome[5, 2] <= 291){
...
if((genome[5, 1] >= 292) & genome[5, 2] <= 302){
...
#Draw terminators
if((genome[10, 1] >= 122) & (genome[10, 2] <= 132)){
...
if((genome[10, 1] >= 133) & (genome[10, 2] <= 143)){
...
if((genome[10, 1] >= 144) & (genome[10, 2] <= 159)){
...
if((genome[11, 1] >= 281) & (genome[11, 2] <= 291)){
...
if((genome[11, 1] >= 292) & (genome[11, 2] <= 302)){
...
if((genome[11, 1] >= 303) & (genome[11, 2] <= 318)){
...
if((genome[7, 1] >= 11) & (genome[7, 2] <= 25)){
...
if((genome[8, 1] >= 122) & (genome[8, 2] <= 132)){
...
if((genome[8, 1] >= 133) & (genome[8, 2] <= 143)){
...
if((genome[8, 1] >= 144) & (genome[8, 2] <= 159)){
...
if((genome[9, 1] >= 281) & (genome[9, 2] <= 291)){
...
if((genome[9, 1] >= 292) & (genome[9, 2] <= 302)){
...
if((genome[9, 1] >= 303) & (genome[9, 2] <= 318)){
