...
setwd("/home/sahil/pinetree-toys/three_genes_evolution/modularized_files/")
...
ggsave("/home/sahil/pinetree-toys/three_genes_evolution/modularized_files/sos_graphs.pdf", sos_plots, width=20, height=10)
```
## R Markdown
...
best_file <- list.files("/home/sahil/pinetree-toys/three_genes_evolution/modularized_files/", pattern="three_genes_replicated_")
best_file <- mixedsort(sort(best_file))

original_data <- read.table("random_data3.tsv", header=TRUE)
...
gen_plots <- grid.arrange(original_line_plot, gen1_line_plot, gen5000_line_plot, gen_final1_line_plot, nrow=2, ncol=3, top="Generational Pattern of Gene Transcripts")
ggsave("/home/sahil/pinetree-toys/three_genes_evolution/modularized_files/gen_graphs.pdf", gen_plots, width=20, height=10)
...
best_files <- list.files("/home/sahil/pinetree-toys/three_genes_evolution/modularized_files/", pattern="three_genes_replicated_")
best_files <- mixedsort(sort(best_files))
plots_list <- list()
target_data <- read.table("random_data3.tsv", header=TRUE)
...
evo_plot <- grid.arrange(target_line_plot, gen1_line_plot, best_plot1, best_plot2, best_plot3, best_plot4, best_plot5, best_plot6, best_plot7, best_plot8, best_plot9, best_plot10, best_plot11, nrow=4, ncol=4, top="Evolutionary Pattern of Gene Transcripts")
ggsave("/home/sahil/pinetree-toys/three_genes_evolution/modularized_files/evolution_graphs.pdf", evo_plot, width=30, height=30, limitsize=FALSE)
