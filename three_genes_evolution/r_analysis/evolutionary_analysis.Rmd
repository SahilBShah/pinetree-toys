...
plots_list <- list()
target_data <- read.table("random_data2.tsv", header=TRUE)
...
evo_plot <- grid.arrange(target_line_plot, best_plot1, best_plot2, best_plot3, best_plot4, best_plot5, best_plot6, nrow=3, ncol=3, top="Evolutionary Pattern of Gene Transcripts")
