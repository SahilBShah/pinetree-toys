...
original_data <- read.table("three_genes_test_file2.tsv", header=TRUE)
...
gen500_data <- read.table("gen_5000_data.tsv", header=TRUE)
...
gen1000_data <- read.table("gen_10000_data.tsv", header=TRUE)
...
plots_list <- list()
target_data <- read.table("three_genes_test_file2.tsv", header=TRUE)
...
evo_plot <- grid.arrange(target_line_plot, gen0_line_plot, best_plot1, best_plot2, best_plot3, best_plot4, best_plot5, best_plot6, best_plot7, best_plot8, best_plot9, best_plot10, nrow=ceiling(length(best_files) / 3), ncol=ceiling(length(best_files) / 3), top="Evolutionary Pattern of Gene Transcripts")
