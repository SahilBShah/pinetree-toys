    ...
    if chosen_modification == 'add':
        ...
        while pol_strength < 0:
            ...
            if pol_strength > 3e10:
                poly_eps = np.random.normal(mu, poly_sigma)
                pol_strength = genome_tracker[chosen_promoter]['current_strength'] + poly_eps
        genome_tracker[chosen_promoter]['previous_strength'] = genome_tracker[chosen_promoter]['current_strength']
...
def modify_terminator(genome_tracker):
    ...
    if chosen_modification == 'add':
        ...
        genome_tracker[chosen_terminator]['previous_strength'] = genome_tracker[chosen_terminator]['current_strength']
