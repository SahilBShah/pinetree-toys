...
```{r}
data <- read_tsv("../data/simulation/three_genes/three_genes_nornase_speed_50.tsv") %>%
...
save_plot("./figures/three_genes_nornase_speed_50.pdf", final_plot, ncol = 2, base_width = 5.5)
```
