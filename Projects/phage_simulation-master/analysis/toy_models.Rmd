...
```{r}
data <- read_tsv("../data/simulation/three_genes/three_genes_rnase_speed_45.tsv") %>%
...
save_plot("./figures/three_genes_rnase_speed_45.pdf", final_plot, ncol = 2, base_width = 5.5)
```
